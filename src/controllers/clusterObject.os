...
// Обработчик действия list - возвращает список объектов кластерами
//
&HTTPMethod("GET")
...
// Обработчик действия get - возвращает описание объекта кластера
//
&HTTPMethod("GET")
Функция get() Экспорт
...
// Функция - преобразует список объеков кластера в формат Prometheus
//
// Параметры:
//   Данные                 - Соответствие    - список объектов кластера
//   ТипОбъектовКластера    - Строка          - тип объектов кластера
//
// Возвращаемое значение:
//   Строка    - список объеков кластера в формате Prometheus
//
...
// Функция - преобразует список объеков кластера в "плоский" текст (Plain)
//
// Параметры:
//   Данные                 - Соответствие    - список объектов кластера
//   ТипОбъектовКластера    - Строка          - тип объектов кластера
//
// Возвращаемое значение:
//   Строка    - список объеков кластера в формате "плоского" текста (Plain)
//
...
// Функция - преобразует описание объекта кластера в формат Prometheus
//
// Параметры:
//   Данные                 - Соответствие    - описание объекта кластера
//   ТипОбъектовКластера    - Строка          - тип объектов кластера
//
// Возвращаемое значение:
//   Строка    - описание объекта кластера в формате Prometheus
//
...
// Функция - преобразует описание объекта кластера в "плоскийо" текст (Plain)
//
// Параметры:
//   Данные            - Соответствие    - описание объекта кластера
//   ТолькоЗначение    - Булево          - Истина - будет выведены только значения полей без имен
//                                         (обычно используется для получения значения только одного поля описания)
//
// Возвращаемое значение:
//   Строка    - описание объекта кластера в формате "плоского" текста (Plain)
//
