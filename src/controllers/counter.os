...
Функция get() Экспорт
	...
	Если ТипОбъектов = "server" Тогда
		Данные = Подключение.Серверы(Поля, Фильтр, Истина);
	ИначеЕсли ТипОбъектов = "process" Тогда
		Данные = Подключение.Процессы(Поля, Фильтр, , Истина);
	ИначеЕсли ТипОбъектов = "infobase" Тогда
		Данные = Подключение.ИнформационныеБазы(Поля, Фильтр, Истина);
	ИначеЕсли ТипОбъектов = "session" Тогда
		Данные = Подключение.Сеансы(Поля, Фильтр, , Истина);
	ИначеЕсли ТипОбъектов = "connection" Тогда
		Данные = Подключение.Соединения(Поля, Фильтр, , Истина);
	Иначе
