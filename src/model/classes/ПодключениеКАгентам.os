...
Процедура ДополнитьОписаниеОбъектаКластера(ПолноеОписаниеОбъекта, ТипОбъекта, Агент, Кластер)
	...
	Если ТипОбъекта = ТипыОбъектовКластера().ИнформационныеБазы Тогда
		...
		СоединениеСУБД = ОбщегоНазначения.СоединениеСУБД(ПараметрыСУБД.СУБД_Тип,
		                                                 ПараметрыСУБД.СУБД_Сервер,
		                                                 ПараметрыСУБД.СУБД_Пользователь,
		                                                 ПараметрыСУБД.СУБД_Пароль);
		
		ЗанимаемоеМесто = СоединениеСУБД.ЗанимаемоеМесто(ПараметрыСУБД.СУБД_База);
