...
Функция ОписаниеОбъектаКластера(ТипОбъекта,
	...
	Для Каждого ТекПолеОписанияОбъекта Из ПолноеОписаниеОбъекта Цикл
		...
		Если НЕ ПолеОсновнойИнформацииИБ(ИмяПоля) И ПолноеОписаниеИБОтсутствует Тогда
		...
		Если НЕ ПолеОсновнойИнформацииИБ(ИмяПоля) Тогда
		...
		Если НЕ ПолеОсновнойИнформацииИБ(ИмяПоля) И НЕ ИБКластера.ПолноеОписание() Тогда
