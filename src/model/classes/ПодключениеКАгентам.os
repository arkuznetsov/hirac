...
Процедура ОбновитьОписанияОбъектовКластера(Знач ТипОбъекта, Знач Обновить = Ложь,
	...
	ТекОбъектыКластера = ОписанияОбъектовКластера(ТипОбъекта);
	Если ТипЗнч(ТекОбъектыКластера) = Тип("Массив") Тогда
		ТекОбъектыКластера.Очистить();
	КонецЕсли;
...
КонецПроцедуры // ОбновитьОписанияОбъектовКластера()

Функция ОписанияОбъектовКластера(Знач ТипОбъекта) Экспорт
