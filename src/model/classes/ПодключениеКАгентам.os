...
Процедура ОбновитьКэшОписанийОбъектовКластеров(Знач ТипОбъекта, Знач Обновить = Ложь)
	...
	Для Каждого ТекАгент Из Агенты Цикл
		...
		Для Каждого ТекОписаниеОбъекта Из ОписанияОбъектовАгента Цикл
			...
			Если НЕ (ДобавлятьОбъект И ОписанияОбъектовКластеров[ИдОбъекта] = Неопределено) Тогда
				Продолжить;
			КонецЕсли;

			ОписанияОбъектовКластеров.Вставить(ИдОбъекта, ТекОписаниеОбъекта.Значение);
		КонецЦикла;
