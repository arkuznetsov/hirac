	...
	Для Каждого ТекСоединение Из СписокСоединений Цикл
		...
		Для Каждого ТекЭлемент Из ПоляСоединения Цикл
			...
			ИначеЕсли ТекЭлемент.Ключ = "process" Тогда
				ОписаниеСоединения.Вставить("process_label", МеткиПроцессов[ЗначениеЭлемента].Метка);
				ОписаниеСоединения.Вставить("process_host", МеткиПроцессов[ЗначениеЭлемента].Сервер);
