...
// Функция - выполняет вызов команды RAC или удаленного сервиса HiRAC
//
// Параметры:
...
//      *params        - Строка    - строка параметров вызова
//      *version       - Строка    - версия утилиты RAC
//      *returnCode    - Строка    - код возврата команды
...
//
// Возвращаемое значение:
//   Массив Из Соответствие    - результат разбора
//
