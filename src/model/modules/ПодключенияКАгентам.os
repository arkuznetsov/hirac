...
Процедура Инициализировать() Экспорт
	...
	РазмерПула               = 20;
	ВремяОжиданияПодключения = 10000;
	МаксВремяБлокировки      = 90000;
...
Функция ОбъектыКластера(Знач ТипОбъекта, Знач Обновить = Ложь, Знач Поля = "_all", Знач Фильтр = Неопределено)
	...
	Попытка
		ОписаниеПодключения.Подключение.ОбновитьОписанияОбъектовКластера(ТипОбъекта, Обновить, Поля, Фильтр);
		ОбъектыКластера = ОписаниеПодключения.Подключение.ОписанияОбъектовКластера(ТипОбъекта);
	Исключение
