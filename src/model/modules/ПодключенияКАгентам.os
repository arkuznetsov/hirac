...
Функция ОбъектыКластера(Знач ТипОбъекта, Знач Обновить = Ложь, Знач Поля = "_all", Знач Фильтр = Неопределено)
	...
	Попытка
		ОписаниеПодключения.Подключение.ОбновитьОбъектыКластера(ТипОбъекта, Обновить, Поля, Фильтр);
		ОбъектыКластера = ОписаниеПодключения.Подключение.ОбъектыКластера(ТипОбъекта);
	Исключение
