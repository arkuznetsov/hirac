...
Функция Счетчики(Знач Объекты,
	             ...
	             Знач Счетчик = "",
	             Знач Измерения = "",
	             Знач АгрегатнаяФункция = "") Экспорт
	...
	Если ЗначениеЗаполнено(Измерения) Тогда
		Для Каждого ТекЭлемент Из Счетчики Цикл
			Если ЗначениеЗаполнено(АгрегатнаяФункция) Тогда
				ТекАгрегатнаяФункция = АгрегатнаяФункция;
			Иначе
				ТекАгрегатнаяФункция = ОписаниеСчетчиков[ТекЭлемент.Ключ]["aggregate"];
			КонецЕсли;
			ТекЭлемент.Значение["values"] = АгрегироватьЗначенияСчетчика(ТекЭлемент.Значение["values"],
			                                                             Измерения,
			                                                             ТекАгрегатнаяФункция);
		КонецЦикла;
	КонецЕсли;
	...
	Возврат Новый Структура("Счетчики, Префикс", Счетчики, ПрефиксСчетчиков);
